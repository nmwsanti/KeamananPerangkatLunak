...
<head>
	...
	<title>Dosen - KPL by NMW</title>
	<style>
	  body {
	   background-image : url("img/orangesky.jpg");
	      ...
	      <ul class="navbar-nav">
	        <li class="nav-item dropdown">
	          ...
	          <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
	            <li><a class="dropdown-item active" href="#">Data Dosen</a></li>
	        ...
	        <li class="nav-item dropdown">
	          ...
	          <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
	            <li><a class="dropdown-item active" href="#">Pengisian Nilai</a></li>
	            <li><a class="dropdown-item active" href="#">Laporan Nilai</a></li>
	           </ul>
	        </li>
	        <li class="nav-item">
